...
/***/
    (function (module, exports, __webpack_require__) {
        ...
        exports.sleep = sleep;
        exports.sneakyHashChange = sneakyHashChange;
        /**
        ...
        function parseColor(color) {
            ...
            var rgbColor = getComputedStyle(elem).color;
            document.body.removeChild(elem);

            // Parse the rgb(r, g, b) color that getComputedStyle returns
            var rgb = rgbColor.split('(')[1].split(')')[0].split(',');
            return {
                r: +rgb[0],
                g: +rgb[1],
                b: +rgb[2]
        ...
        var ease = exports.ease = {
            ...
            out: function out(x) {
                return 1 - window.ease.in(1 - x);
            },
            // Sinusoidal easing
            inSin: function inSin(x) {
                return 1 - Math.cos(0.5 * Math.PI * x);
            },
            outSin: function outSin(x) {
         ...
         * the history stack.
         */
        function sneakyHashChange(newHash) {
            var push = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;

            var hash = newHash.startsWith('#') ? newHash : '#' + newHash;
...
/***/
    (function (module, exports, __webpack_require__) {
        ...
        var _laptops = __webpack_require__(342);

        var _navShrink = __webpack_require__(343);

        var _navShrink2 = _interopRequireDefault(_navShrink);

        var _navShrink3 = __webpack_require__(344);

        var _navShrink4 = _interopRequireDefault(_navShrink3);

        var _navShrink5 = __webpack_require__(345);

        var _navShrink6 = _interopRequireDefault(_navShrink5);
        ...
        var Navigation = exports.Navigation = function () {
            ...
            function Navigation() {
                ...
                window.addEventListener('popstate', function () {
                    _this.forbidPush = true;
                });
                // Navigate whenever hash changes
                window.addEventListener('hashchange', function () {
                    return _this.navigateTo(Navigation.hash);
                });
                ...
                document.getElementById('navigation-trigger').addEventListener('click', function () {
                    return _this.toggle();
                });
                ...
                var laptopsContainer = document.getElementsByClassName('laptops-container')[0];
                var laptopElems = [].concat(_toConsumableArray(laptopsContainer.getElementsByClassName('laptop3d')));
                var laptops = laptopElems.map(function (l, i) {
                    return new _laptops.Laptop(l, i - 1);
                });
                // Create laptop carousel
                this.carousel = new _laptops.LaptopCarousel(laptopsContainer, laptops, this);

                // Shrink other pages
                var otherpages = this.pages.filter(function (n) {
                    return n !== _this.currentPage;
                });
                otherpages.forEach(function (page) {
                    return page.update(1.0);
                });
            ...
            _createClass(Navigation, [{
                ...
                value: function keyBind() {
                    ...
                    window.addEventListener('keydown', function (e) {
                        ...
                        if (e.key === 'ArrowDown') _this2.open();
                        // Close navigation when escape, up, or enter is pressed
                        if (e.key === 'Escape' || e.key === 'ArrowUp' || e.key === 'Enter') _this2.close();
                        // Toggle navigation when space is pressed
                        if (e.key === ' ') _this2.toggle();
                        // Carousel left/right when navigation shown
                        if (_this2.shown) {
                            if (e.key === 'ArrowRight') _this2.carousel.right();
                            if (e.key === 'ArrowLeft') _this2.carousel.left();
                        }
                    });
                    ...
                    window.addEventListener('wheel', function (e) {
                        if (!_this2.disableScrollBinding) {
                            // Vertical scroll
                            if (Math.abs(e.deltaY) > Math.abs(e.deltaX)) {
                                if (e.deltaY > 2) _this2.open();
                                if (e.deltaY < -2) _this2.close();
                            }
                ...
                value: function animationStarted() {
                    ...
                    if (typeof this._safeToAnimate === 'undefined') {
                        ...
                        this._safeToAnimate = new Promise(function (resolve) {
                            _this3.animationFinished = function () {
                                resolve();
                                _this3._safeToAnimate = undefined;
                            };
                        });
                    } else {
                ...
                value: function navigateTo(hash) {
                    ...
                    return new Promise(async function (resolve) {
                        await _this4.open();
                        await (0, _helpers.sleep)(150);
                        await _this4.carousel.getLaptopWithHash(hash).centerSelf();
                        await (0, _helpers.sleep)(150);
                        await _this4.close();
                        resolve();
                    });
                ...
                key: 'transitionUpdate',
                value: function transitionUpdate(progress) {
                    var _this5 = this;
                    ...
                    return new Promise(function (resolve) {
                        ...
                        requestAnimationFrame(function () {
                            _this5.currentPage.update(progress);
                            resolve();
                        });
                    });
                }
                ...
                value: async function open() {
                    ...
                    return new Promise(function (resolve) {
                        ...
                        if (!_this6.shown) {
                            _this6.animationStarted();
                            // Set up each animation frame for its correct time

                            var _loop = function _loop(i) {
                                setTimeout(function () {
                                        return _this6.transitionUpdate(os(i));
                                    }, // Update to proper progress
                                    i * _this6.navTransitionDuration // at proper time
                                );
                            };
                            ...
                            setTimeout(async function () {
                                await _this6.transitionUpdate(1);
                                _this6.animationFinished();
                                resolve();
                            }, _this6.navTransitionDuration);
                            _this6.shown = true;
                ...
                value: async function close() {
                    ...
                    return new Promise(function (resolve) {
                        // Only needs to happen if it's not already open
                        if (_this7.shown) {
                            _this7.animationStarted();
                            // Set up each animation frame for its correct time

                            var _loop2 = function _loop2(i) {
                                setTimeout(function () {
                                        return _this7.transitionUpdate(1 - os(i));
                                    }, // Update to proper progress
                                    i * _this7.navTransitionDuration // at proper time
                                );
                            };
                            ...
                            // When we're finished
                            setTimeout(async function () {
                                await _this7.transitionUpdate(0);
                                _this7.animationFinished();
                                resolve();
                            }, _this7.navTransitionDuration);
                            _this7.shown = false;
                            // If it's already open, resolve immediately
                        } else {
                            resolve();
                ...
                get: function get() {
                    if (this._safeToAnimate) {
                        var promise = this._safeToAnimate;
                        this._safeToAnimate = new Promise(function () {});
                        return promise;
                    }
                    return undefined;
                }
                ...
                key: 'navBarUpdate',
                value: function navBarUpdate() {
                    var linkToHere = document.getElementById('navigation').querySelector('a[href=\'#' + Navigation.hash + '\']');
                    // un-highlight all the links
                    document.getElementById('navigation').querySelectorAll('a').forEach(function (a) {
        ...
        function init() {
            window.nav = window.navigation = new Navigation(new _navShrink4.default(), new _navShrink2.default(), new _navShrink6.default());
        }
...
/***/
    (function (module, exports, __webpack_require__) {
        ...
        var NavigationAnimationBase = function () {
            _createClass(NavigationAnimationBase, null, [{
                key: 'tween',
                 ...
                 */
                value: function tween(a, b, progress) {
            ...
            function NavigationAnimationBase() {
                _classCallCheck(this, NavigationAnimationBase);

                // Elements that need to be referenced
                this.elem = {
                    laptop: function laptop(hash) {
                        var h = hash === 'home' ? '' : hash; // 'home' -> ''
                        return document.querySelector('.laptop3d[data-laptop3d-hash=\'' + h + '\']');
                    },
                    laptopContent: function laptopContent(hash) {
            ...
            _createClass(NavigationAnimationBase, [{
                key: 'update',
                value: function update(progress) {
                    // Adjust scale
                    this.scale(this.elem.laptopContent(this.hash).getBoundingClientRect(), progress);
                ...
                key: 'scale',
                value: function scale(laptopScreenCoordinates, progress) {
                    ...
                    var posB = laptopScreenCoordinates;

                    // Calculate translation needed
                    // (Center is used for calculating translation because element is scaled about the center)
                    var centerA = NavigationAnimationBase.getCenter(posA);
                    var centerB = NavigationAnimationBase.getCenter(posB);
      ...
      // Translate
      'translateX(' + NavigationAnimationBase.tween(0, translationNeeded.x, progress) + 'px)', 'translateY(' + NavigationAnimationBase.tween(0, translationNeeded.y, progress) + 'px)',
      // Scale
      'scaleX(' + NavigationAnimationBase.tween(1, scaleNeeded.x, progress) + ')', 'scaleY(' + NavigationAnimationBase.tween(1, scaleNeeded.y, progress) + ')'].join(' ');
                ...
                value: function putInLaptop() {
                    ...
                    // .front
                    var screenBezel = window.sassHeightVariable * 0.85;
                ...
                key: 'removeFromLaptop',
                value: function removeFromLaptop() {
            ...
            return NavigationAnimationBase;
        }();

        exports.default = NavigationAnimationBase;
...
/***/
    (function (module, exports, __webpack_require__) {
        ...
        var Parallax3D = function () {
             ...
             */
            function Parallax3D(element) {
                var _this = this;

                var initialTransform = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
                var rotmax = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 10;
            ...
            _createClass(Parallax3D, [{
                ...
                value: function mouse(e) {
                    ...
                    var x = e.clientX;
                    var y = e.clientY;
                    var finalx = (x - halfw) / halfw;
                    var finaly = (y - halfh) / halfh;
                    var _ref = [finalx, finaly];
                    this.mousePos.x = _ref[0];
                    this.mousePos.y = _ref[1];
                }
                ...
                value: function rotate() {
                    if (!this.disabled) {
                        this.elem.style.transform = [this.initialTransform, 'rotateX(' + this.mousePos.y * this.rotmax + 'deg)', 'rotateY(' + -this.mousePos.x * this.rotmax + 'deg)'].join(' ');
                    }
                }
...
/***/
    (function (module, exports, __webpack_require__) {
        ...
        $export($export.P + $export.R, 'Map', {
            toJSON: __webpack_require__(125)('Map')
        });
...
/***/
    (function (module, exports, __webpack_require__) {
        ...
        $export($export.P + $export.R, 'Set', {
            toJSON: __webpack_require__(125)('Set')
        });
...
/***/
    (function (module, exports, __webpack_require__) {
        ...
        var _browsercheck = __webpack_require__(339);
        ...
        var _work = __webpack_require__(348);
        ...
        document.addEventListener('DOMContentLoaded', function () {
            setTimeout(_browsercheck2.default, 1000);
    ...
    (function (module, exports, __webpack_require__) {
        ...
        function browserCheck() {
            if (!window.isChromium) {
                var willWork = window.isSafari || window.isFirefox;
                // Different popups if the browser is partially supported or entirely unsupported
                var popup = document.getElementById(willWork ? 'browser-partially-supported' : 'browser-unsupported');
                // Only the "partially supported" popup can be dismissed
                if (willWork) {
                    popup.getElementsByTagName('button')[0].addEventListener('click', function () {
...
/***/
    (function (module, exports, __webpack_require__) {
        ...
        var _gol = __webpack_require__(341);

        function init() {
            // Set up game of life
            window.gol = new _gol.GameRenderer('#gol');
            window.gol.start();
...
/***/
    (function (module, exports, __webpack_require__) {
        ...
        var Game = exports.Game = function () {
            ...
            _createClass(Game, [{
                ...
                value: function getBlankBoard() {
                    ...
                    return new Array(this.boardSize[0]).fill(0).map(function () {
                        return new Array(_this.boardSize[1]).fill(false);
                    });
                }
                ...
                value: function randomize() {
                    ...
                    while (JSON.stringify(this.board) === JSON.stringify(oldBoard)) {
                        this.board = this.getBlankBoard().map(function () {
                            return _this2.getRandomRow();
                        });
                    }
                    return this;
                }
                ...
                key: 'setState',
                value: function setState(x, y, value) {
                    var _this3 = this;
                    ...
                    } else if ((typeof x === 'undefined' ? 'undefined' : _typeof(x)) === 'object' && typeof x[0][0] === 'number') {
                        // A list of coordinate pairs was passed
                        x.forEach(function (coords) {
                            _this3.board[coords[0]][coords[1]] = value;
                        });
                    }
                    return this;
                }
                ...
                value: function countLiveNeighbors(x, y) {
                    ...
                    var xroomneg = x > 0;
                    var yroomneg = y > 0;
                    var xroompos = x < this.boardSize[0] - 1;
                    var yroompos = y < this.boardSize[1] - 1;
      ...
      xroomneg && yroompos && this.board[x - 1][y - 1]];
                 ...
                 */
                value: function step() {
                    var newState = this.getBlankBoard();

                    for (var x = 0; x < this.boardSize[0]; x += 1) {
                        for (var y = 0; y < this.boardSize[1]; y += 1) {
                            newState[x][y] = Game.judgeFate(this.board[x][y], this.countLiveNeighbors(x, y));
                        }
                    }
                ...
                key: 'changeSize',
                value: function changeSize(width, height, shouldRandomize) {
                    // Store old board size
                    var oldBoardSize = this.boardSize;
                    var newBoardSize = [width, height];
                    // Calculate size difference
                    var diff = [newBoardSize[0] - oldBoardSize[0], newBoardSize[1] - oldBoardSize[1]];
                    ...
                    if (diff[1] < 0) {
                        ...
                        this.board = this.board.map(function (row) {
                            return row.slice(0, newBoardSize[1]);
                        });
                    }
                    ...
                    // Add new rows
                    for (var i = 0; i < diff[0]; i += 1) {
                        this.board.push(shouldRandomize ? this.getRandomRow() : new Array(this.boardSize[0]).fill(false));
                    }
                    // Add new cells to existing rows (new columns)
                    for (var _i = 0; _i < diff[1]; _i += 1) {
                        for (var k = 0; k < this.board.length; k += 1) {
                ...
                value: function toString() {
                    function boolToAscii(n) {
                        return n ? 'o' : '.';
                    }
                    return this.board.map(function (row) {
                        return row.map(boolToAscii).join('');
                    }).join('\n');
                }
                ...
                key: 'judgeFate',
                value: function judgeFate(isLive, liveNeighbors) {
                    if (isLive) {
        ...
        var GameRenderer = exports.GameRenderer = function () {
            /**
             ...
             */
            function GameRenderer(selector) {
                var fps = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 15;
                var cellSize = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 20;

                var _this4 = this;

                var cellColor = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '#232327';
                var randomize = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : true;
                ...
                this.elem.addEventListener('mousemove', function (e) {
                    return _this4.mouse(e.clientX, e.clientY);
                });
            }
            ...
            _createClass(GameRenderer, [{
                ...
                value: function updateSize() {
                    ...
                    this.cellSize = [width / Math.round(width / this.idealCellSize), height / Math.round(height / this.idealCellSize)];

                    this.game.changeSize(Math.round(width / this.cellSize[0]), Math.round(height / this.cellSize[1]), this.isRandom);
                ...
                value: function draw() {
                    ...
                    requestAnimationFrame(function () {
                        ...
                        if (_this5.needsSizeUpdate) {
                            _this5.needsSizeUpdate = false;
                            _this5.updateSize();
                        }

                        var width = _this5.elem.getAttribute('width');
                        var height = _this5.elem.getAttribute('height');

                        _this5.context.clearRect(0, 0, width, height);
                        _this5.context.fillStyle = _this5.cellColor;
                        // Render board
                        for (var x = 0; x < _this5.game.boardSize[0]; x += 1) {
                            for (var y = 0; y < _this5.game.boardSize[1]; y += 1) {
                                if (_this5.game.board[x][y]) {
                                    _this5.context.fillRect(_this5.cellSize[0] * x, _this5.cellSize[1] * y, _this5.cellSize[0], _this5.cellSize[1]);
                                }
                            }
                        }
                    });
                ...
                key: 'mouse',
                value: function mouse(mousex, mousey) {
                    // Position of the canvas in the viewport
                    var bbox = this.elem.getBoundingClientRect();

                    // If the mosue is over the canvas
                    if (mousex > bbox.left && mousey > bbox.top && mousex < bbox.right && mousey < bbox.bottom) {
                        // Calculate mouse position relative to canvas
                        var relx = mousex - bbox.left;
                        var rely = mousey - bbox.top;
                        // Calculate cell position
                        var cellx = Math.floor(relx / this.cellSize[0]);
                        var celly = Math.floor(rely / this.cellSize[1]);
...
/***/
    (function (module, exports, __webpack_require__) {
        ...
        exports.LaptopCarousel = exports.Laptop = undefined;
        ...
        var Laptop = exports.Laptop = function () {
            ...
            function Laptop(elem, index) {
                ...
                var children = [].concat(_toConsumableArray(this.elem.childNodes));
                this.elem.innerHTML = '\n      <div class="wrapper">\n        <div class="base"><div class="front"></div></div>\n        <div class="lid">\n          <div class="front">\n            <div class="screen"></div>\n          </div>\n          <div class="back"></div>\n        </div>\n      </div>\n    ';
                // Record some common elements as properties
    ['wrapper', 'base', 'lid', 'screen'].forEach(function (name) {
                    _this[name] = _this.elem.getElementsByClassName(name)[0];
                });
                // Add all former children to the new screen element
                children.forEach(function (child) {
                    return _this.screen.appendChild(child);
                });
                ...
                this.wrapper.addEventListener('click', function () {
                    if (_this.carousel) {
                        if (_this.index !== _this.carousel.position) _this.centerSelf();
                        else if (_this.carousel.navigation) _this.carousel.navigation.close();
                    }
                });
            ...
            _createClass(Laptop, [{
                ...
                value: function centerSelf() {
                    ...
                    return new Promise(function (resolve, reject) {
                        ...
                        if (_this2.carousel) {
                            ...
                            if (_this2.index === _this2.carousel.position) resolve();
                            // Otherwise change and resolve when CSS animation will have finished
                            else {
                                _this2.carousel.position = _this2.index;
                                setTimeout(resolve, _this2.carousel.getTimeToPos(_this2.index));
                            }
                ...
                value: function _applyTransform() {
                    this.wrapper.style.transform = ['rotateX(' + this._rotateX + ')', 'rotateY(' + this._rotateY + ')', 'rotateZ(' + this._rotateZ + ')', 'translateX(' + this._translateX + ')', 'translateY(' + this._translateY + ')', 'translateZ(' + this._translateZ + ')'].join(' ');
                 ...
                 */
                value: function _setRotate(axis, val) {
                    if (!['X', 'Y', 'Z'].includes(axis)) throw new Error('Axis must be one of X Y or Z'); // val must be XYZ
                    var prop = '_rotate' + axis; // Property that we're setting
                 ...
                 */
                value: function _setRotatePromise(axis, val) {
                    var _this3 = this;

                    return new Promise(function (resolve) {
                        // Resolve instantly if nothing is changing
                        if (_this3['_rotate' + axis] === val) resolve();
                        // Otherwise change and resolve when CSS animation will have finished
                        else {
                            _this3._setRotate(axis, val);
                            setTimeout(resolve, _this3.transitionTime * 1000);
                        }
                    });
                }
  }, {
                key: 'setRotateX',
                value: function setRotateX(val) {
                    return this._setRotatePromise('X', val);
                }
  }, {
                key: 'setRotateY',
                value: function setRotateY(val) {
                    return this._setRotatePromise('Y', val);
                }
  }, {
                key: 'setRotateZ',
                value: function setRotateZ(val) {
                    return this._setRotatePromise('Z', val);
                }
                 ...
                 */
                value: function setLidAngle(val) {
                    var _this4 = this;

                    // promise version
                    return new Promise(function (resolve) {
                        // Resolve instantly if nothing is changing
                        if (_this4.lidAngle === val) resolve();
                        // Otherwise change and resolve when CSS animation will have finished
                        else {
                            _this4.lidAngle = val;
                            setTimeout(resolve, _this4.transitionTime * 1000);
                        }
                    });
                }
        ...
        var LaptopCarousel = exports.LaptopCarousel = function () {
            _createClass(LaptopCarousel, null, [{
                key: 'rotLimit',
                get: function get() {
                    return 75;
                }
            ...
            function LaptopCarousel(container, laptops, navigation) {
                var _this5 = this;

                _classCallCheck(this, LaptopCarousel);
                ...
                // Sort by index
                this.laptops.sort(function (a, b) {
                    return a.index - b.index;
                });
                // Check that there are no overlapping indices
                var indices = this.laptops.map(function (l) {
                    return l.index;
                });
                ...
                this.laptopsByIndex = {};
                laptops.forEach(function (l) {
                    _this5.laptopsByIndex[l.index] = l;
                });

                if (this.navigation) this._position = this.getLaptopWithHash(_.Navigation.hash).index;
            ...
            _createClass(LaptopCarousel, [{
                key: 'getTimeToPos',


                /** Return the number of milliseconds it would take to transition to a given position */
                value: function getTimeToPos(pos) {
                    var total = 0;
                    var delta = Math.abs(this._position - pos);
                ...
                key: 'addLaptop',
                value: function addLaptop(laptop) {
                ...
                key: 'removeLaptop',
                value: function removeLaptop(laptop) {
                ...
                key: 'getLaptopWithHash',
                value: function getLaptopWithHash(hash) {
                    return this.laptops.filter(function (n) {
                        return n.hash === hash;
                    })[0];
                }
  }, {
                key: 'indices',
                get: function get() {
                    return this.laptops.map(function (l) {
                        return l.index;
                    });
                }
                ...
                key: 'minIndex',
                get: function get() {
                    return Math.min.apply(Math, _toConsumableArray(this.indices));
                }
                ...
                key: 'maxIndex',
                get: function get() {
                    return Math.max.apply(Math, _toConsumableArray(this.indices));
                }
                ...
                set: function set(pos) {
                    ...
                    (async function () {
                        ...
                        if (_this6.navigation) {
                            await _this6.navigation.safeToAnimate; // Wait for it to be safe to animate
                            _this6.navigation.animationStarted(); // Register that an animation is in progress
                        }

                        // Cancel hover effect
                        _this6.laptops.forEach(function (laptop) {
                            laptop.translateZ = 0;
                        });

                        // Close laptops
                        var lidsClosed = _this6.laptops.filter(function (laptop) {
                                return laptop.index !== pos;
                            }) // Exclude the one we're about to open
                            .map(function (laptop) {
                                return laptop.setLidAngle(0);
                            }); // But close the rest
                        await Promise.all(lidsClosed); // Wait for all to close
                        _this6.laptops.forEach(function (l) {
                            l.screen.style.display = 'none';
                        });

                        // Update internal position value
                        var delta = Math.abs(_this6._position - pos);
                        _this6._position = pos;

                        // Navigation things
                        (0, _helpers.sneakyHashChange)(_this6.laptopsByIndex[pos].hash, _this6.shouldPushState); // change URL hash
                        _.Navigation.navBarUpdate(); // Change top bar appearance
                        // Reset shouldPushState (should only push once until explicitly set to push again)
                        if (_this6.shouldPushState) _this6.shouldPushState = false;

                        // Rotate laptops
                        var rotations = _this6.laptops.map(function (laptop) {
                            var baseRot = laptop.index * -_this6.offsetAngle; // laptop rotation when position is 0
                            var finalRot = baseRot + _this6.position * _this6.offsetAngle; // Adjust for position
                            laptop.transitionTime = (1 + (delta - 1) * 0.5) * _this6.baseTransitionTime;
                        ...
                        _this6.transitionTime = _this6.baseTransitionTime;

                        // Open the selected laptop
                        if (_this6.position in _this6.laptopsByIndex) {
                            _this6.laptopsByIndex[pos].screen.style.display = '';
                            await _this6.laptopsByIndex[pos].setLidAngle(100);
                        }

                        _this6.navigation.animationFinished();
                    })();
                }
  }, {
                key: 'transitionTime',
                set: function set(secs) {
                    this.laptops.forEach(function (l) {
                        l.transitionTime = secs;
                    });
                },
                get: function get() {
                    var answer = this.laptops[0].transitionTime;
                    // Warn if not every laptop has the same transitionTime
                    if (!this.laptops.every(function (laptop) {
                            return laptop.transitionTime === answer;
                        })) console.warn('LaptopCarousel.transitionTime called but transitionTime of laptops is inconsistent');
                    return answer;
                }
  }, {
                key: 'baseTransitionTime',
                get: function get() {
                    var answer = this.laptops[0].baseTransitionTime;
                    // Warn if not every laptop has the same baseTransitionTime
                    if (!this.laptops.every(function (laptop) {
                            return laptop.baseTransitionTime === answer;
                        })) console.warn('LaptopCarousel.baseTransitionTime called but baseTransitionTime of laptops is inconsistent');
                    return answer;
                }
  }], [{
                key: 'boundRotation',
                value: function boundRotation(rot) {
                    var sign = Math.sign(rot);
                    return sign * Math.min(Math.abs(rot), LaptopCarousel.rotLimit);
                }
  }]);

            return LaptopCarousel;
        }();
...
/***/
    (function (module, exports, __webpack_require__) {
        ...
        var _animBase = __webpack_require__(92);

        var _animBase2 = _interopRequireDefault(_animBase);
         ...
         */
        var HomeNavigationAnimation = function (_NavigationBase) {
            _inherits(HomeNavigationAnimation, _NavigationBase);

            function HomeNavigationAnimation() {
                _classCallCheck(this, HomeNavigationAnimation);

                var _this = _possibleConstructorReturn(this, (HomeNavigationAnimation.__proto__ || Object.getPrototypeOf(HomeNavigationAnimation)).call(this));

                _this.hash = 'home';
                // Add elements to this.elem
                Object.assign(_this.elem, {
                    ...
                    get title() {
                        ...
                        Object.defineProperty(this, 'title', {
                            value: this.wrapper.getElementsByTagName('h1')[0]
                        });
                        return this.title;
                    }
                });
            ...
            _createClass(HomeNavigationAnimation, [{
                key: 'scale',
                value: function scale(laptopScreenCoordinates, progress) {
                    // 1. Fit background to laptop screen
                    ...
                    var w = window.innerWidth;
                    var h = window.innerHeight;
                    var translationNeeded = _get(HomeNavigationAnimation.prototype.__proto__ || Object.getPrototypeOf(HomeNavigationAnimation.prototype), 'scale', this).call(this, laptopScreenCoordinates, progress)[0];

                    // 2. Fit name to laptop screen

                    this.elem.title.style.transform = ['translate(-50%, -50%)', 'translateX(' + _animBase2.default.tween(0, translationNeeded.x, progress) + 'px)', 'translateY(' + _animBase2.default.tween(0, translationNeeded.y, progress) + 'px)', 'scale(' + _animBase2.default.tween(1, 0.5, progress) + ')'].join(' ');

                    // 3. Adjust canvas settings

                    var canvasRect = this.elem.canvas.getBoundingClientRect();
                    // How much canvas has been downscaled overall? Averages X and Y scale factors to get a holistic
                    // scale factor
                    var horizontalScaleFactor = canvasRect.width / w;
                    var verticalScaleFactor = canvasRect.height / h;
                    var averageScaleFactor = (horizontalScaleFactor + verticalScaleFactor) / 2;
                    window.gol.idealCellSize = 20 * averageScaleFactor;
                    window.gol.needsSizeUpdate = true;

                    _get(HomeNavigationAnimation.prototype.__proto__ || Object.getPrototypeOf(HomeNavigationAnimation.prototype), 'scale', this).call(this, laptopScreenCoordinates, progress);
                }
  }, {
                key: 'putInLaptop',
                value: function putInLaptop() {
                    _get(HomeNavigationAnimation.prototype.__proto__ || Object.getPrototypeOf(HomeNavigationAnimation.prototype), 'putInLaptop', this).call(this);
                ...
                key: 'removeFromLaptop',
                value: function removeFromLaptop() {
                    _get(HomeNavigationAnimation.prototype.__proto__ || Object.getPrototypeOf(HomeNavigationAnimation.prototype), 'removeFromLaptop', this).call(this);
            ...
            return HomeNavigationAnimation;
        }(_animBase2.default);

        exports.default = HomeNavigationAnimation;
...
/***/
    (function (module, exports, __webpack_require__) {
         ...
         * @extends NavigationAnimationBase
         */
        var AboutNavigationAnimation = function (_NavigationBase) {
            _inherits(AboutNavigationAnimation, _NavigationBase);

            function AboutNavigationAnimation() {
                _classCallCheck(this, AboutNavigationAnimation);

                var _this = _possibleConstructorReturn(this, (AboutNavigationAnimation.__proto__ || Object.getPrototypeOf(AboutNavigationAnimation)).call(this));
            ...
            _createClass(AboutNavigationAnimation, [{
                key: 'scale',
                value: function scale(laptopScreenCoordinates, progress) {
                    var scaleInfo = _get(AboutNavigationAnimation.prototype.__proto__ || Object.getPrototypeOf(AboutNavigationAnimation.prototype), 'scale', this).call(this, laptopScreenCoordinates, progress);

                    var _scaleInfo = _slicedToArray(scaleInfo, 1),
                        translationNeeded = _scaleInfo[0];

                    var windowAspect = window.innerWidth / window.innerHeight;
                    var laptopAspect = laptopScreenCoordinates.width / laptopScreenCoordinates.height;
                    var scaleNeeded = void 0;
                    if (windowAspect >= laptopAspect) {
                        // window aspect is wider than laptop; have to fit to width
                        scaleNeeded = laptopScreenCoordinates.width / window.innerWidth;
                    } else {
                        // window aspect is taller than laptop; have to fit to height
                        scaleNeeded = laptopScreenCoordinates.height / window.innerHeight;
                    }
                    var translate = _animBase2.default.tween(0, translationNeeded.y, progress);
                    var scale = _animBase2.default.tween(1, scaleNeeded, progress);
                ...
                key: 'putInLaptop',
                value: function putInLaptop() {
                    _get(AboutNavigationAnimation.prototype.__proto__ || Object.getPrototypeOf(AboutNavigationAnimation.prototype), 'putInLaptop', this).call(this);
                ...
                key: 'removeFromLaptop',
                value: function removeFromLaptop() {
                    _get(AboutNavigationAnimation.prototype.__proto__ || Object.getPrototypeOf(AboutNavigationAnimation.prototype), 'removeFromLaptop', this).call(this);
            ...
            return AboutNavigationAnimation;
        }(_animBase2.default);

        exports.default = AboutNavigationAnimation;
...
/***/
    (function (module, exports, __webpack_require__) {
         ...
         * @extends NavigationAnimationBase
         */
        var WorkNavigationAnimation = function (_NavigationBase) {
            _inherits(WorkNavigationAnimation, _NavigationBase);

            function WorkNavigationAnimation() {
                _classCallCheck(this, WorkNavigationAnimation);

                var _this = _possibleConstructorReturn(this, (WorkNavigationAnimation.__proto__ || Object.getPrototypeOf(WorkNavigationAnimation)).call(this));
            ...
            _createClass(WorkNavigationAnimation, [{
                key: 'scale',
                value: function scale(laptopScreenCoordinates, progress) {
                    var scaleInfo = _get(WorkNavigationAnimation.prototype.__proto__ || Object.getPrototypeOf(WorkNavigationAnimation.prototype), 'scale', this).call(this, laptopScreenCoordinates, progress);

                    var _scaleInfo = _slicedToArray(scaleInfo, 2),
                        scaleNeeded = _scaleInfo[1];

                    var targetScale = laptopScreenCoordinates.width / window.innerWidth;
                    var scale = _animBase2.default.tween(1, targetScale, progress);

                    var targetTagsTop = laptopScreenCoordinates.top + scaleNeeded.y * this.elem.tags.offsetTop;
                    var targetTagsTranslate = targetTagsTop - this.elem.tags.offsetTop;
                    var tagsTranslate = _animBase2.default.tween(0, targetTagsTranslate, progress);
                    // Store as attributes for use later
                    ...
                    var targetCarouselY = laptopScreenCoordinates.top + laptopScreenCoordinates.height / 2;
                    var targetCarouselTranslate = targetCarouselY - window.innerHeight / 2;
                    var carouselTranslate = _animBase2.default.tween(0, targetCarouselTranslate, progress);
                ...
                key: 'putInLaptop',
                value: function putInLaptop() {
                    _get(WorkNavigationAnimation.prototype.__proto__ || Object.getPrototypeOf(WorkNavigationAnimation.prototype), 'putInLaptop', this).call(this);
                ...
                key: 'removeFromLaptop',
                value: function removeFromLaptop() {
                    _get(WorkNavigationAnimation.prototype.__proto__ || Object.getPrototypeOf(WorkNavigationAnimation.prototype), 'removeFromLaptop', this).call(this);
            ...
            return WorkNavigationAnimation;
        }(_animBase2.default);

        exports.default = WorkNavigationAnimation;
...
/***/
    (function (module, exports, __webpack_require__) {
        ...
        var _age = __webpack_require__(347);

        var _age2 = _interopRequireDefault(_age);

        var _parallax = __webpack_require__(128);
        ...
        function init() {
            // .info
            var elem = (_navigation.Navigation.hash === 'about' ? document.getElementById('about-wrapper') : window.navigation.carousel.getLaptopWithHash('about').screen).getElementsByClassName('info')[0];

            // Create Parallax
            window.parallax = new _parallax2.default(elem, 'translate(-50%, -50%)');
            // Disable if not shown
            if (_navigation.Navigation.hash !== 'about') window.parallax.disable();
            // Set up age renderer
            new _age2.default(document.getElementById('age'), Date.parse('11/06/1994 06:23')).loop();

            // Set up flipping
  ['social-trigger', 'social-close'].forEach(function (id) {
...
/***/
    (function (module, exports, __webpack_require__) {
        ...
        var AgeRenderer = function () {
             ...
             */
            function AgeRenderer(elem, date) {
                var accuracy = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 9;

                _classCallCheck(this, AgeRenderer);
...
/***/
    (function (module, exports, __webpack_require__) {
        ...
        var _ghStars = __webpack_require__(350);

        var _ghStars2 = _interopRequireDefault(_ghStars);
        ...
        exports.default = async function init() {
            ...
            var cardElems = [].concat(_toConsumableArray(projectsContainer.getElementsByClassName('carousel-card')));
            var cards = cardElems.map(function (c) {
                return new _carousel.CarouselCard(c);
            });

            var dotsElem = document.getElementById('carousel-dots');
            var dots = new _carousel.CarouselDots(dotsElem);

            var tagsContainer = document.getElementById('tags');
            var tagElems = [].concat(_toConsumableArray(tagsContainer.getElementsByClassName('tag')));
            var tags = tagElems.map(function (t) {
                return new _carousel.CarouselTag(t);
            });

            var emptyElem = document.getElementById('carousel-empty-state');
            var closeButton = document.getElementById('carousel-close-button');

            window.workCarousel = new _carousel.Carousel(cards, dots, tags, emptyElem, closeButton);

            // Add number of github stars to all applicable cards
            var starsMap = await (0, _ghStars2.default)();
            window.starsMap = starsMap;

            var starsElems = projectsContainer.getElementsByClassName('stars-display');
  [].concat(_toConsumableArray(starsElems)).forEach(function (sel) {
                var repoNames = (sel.dataset.repo || '').split(',').map(function (t) {
                    return t.trim();
                });
                var starsCount = repoNames.map(function (r) {
                        return starsMap[r];
            ...
            var videos = [].concat(_toConsumableArray(projectsContainer.getElementsByTagName('video')));
            videos.forEach(function (v) {
                return v.parentNode.addEventListener('click', function () {
                    if (v.paused) {
                        // Play
                        v.play();
                        v.parentNode.classList.remove('paused');
                        // Pause others
                        videos.filter(function (vid) {
                            return vid !== v;
                        }).forEach(function (otherVid) {
                            otherVid.pause();
...
/***/
    (function (module, exports, __webpack_require__) {
        ...
        exports.Carousel = exports.CarouselCard = exports.CarouselDots = exports.CarouselTag = undefined;
        ...
        var CarouselTag = exports.CarouselTag = function () {
            function CarouselTag(elem) {
                var _this = this;

                _classCallCheck(this, CarouselTag);
            ...
            _createClass(CarouselTag, [{
                ...
                key: 'fade',
                value: function fade() {
                    this.elem.classList.add('faded');
                }
  }, {
                key: 'opacify',
                value: function opacify() {
                    this.elem.classList.remove('faded');
                }
  }]);
        ...
        var CarouselDots = exports.CarouselDots = function () {
            function CarouselDots(elem) {
                _classCallCheck(this, CarouselDots);

                this.elem = elem;
                this.carousel = undefined; // Will be set when added to a carousel
            }

            _createClass(CarouselDots, [{
                key: 'init',
                value: function init() {
                    var _this3 = this;

                    this.dots = this.carousel.cards.map(function (c, i) {
                    ...
                    this.dots.forEach(function (d) {
                        return _this3.elem.appendChild(d);
                    });
                    ...
                    this.dots.forEach(function (d, i) {
                        return d.addEventListener('click', function () {
                            return _this3.clicked(i);
                        });
                    });
                    this.left.addEventListener('click', function () {
                        return _this3.carousel.left();
                    });
                    this.right.addEventListener('click', function () {
                        return _this3.carousel.right();
                    });
                    this.layout();
                }
  }, {
                ...
                value: function update() {
                    ...
                    var selectedIndex = this.carousel.cards.indexOf(this.carousel.cards.filter(function (c) {
                        return !c.hidden;
                    })[this.carousel.position]);
                    // Clean slate
                    this.dots.forEach(function (d) {
                        return d.classList.remove('active', 'disabled');
                    });
                    // Expand active dot
                    if (selectedIndex !== -1) this.dots[selectedIndex].classList.add('active');
                    // Disable hidden dots
                    this.carousel.hiddenIndices.forEach(function (i) {
                        return _this4.dots[i].classList.add('disabled');
                    });
                }
  }, {
                key: 'clicked',
                value: function clicked(i) {
        ...
        var CarouselCard = exports.CarouselCard = function () {
            function CarouselCard(elem, tagNames) {
                var _this5 = this;
                ...
                this.tagNames = tagNames || elem.dataset.tags.split(',').map(function (t) {
                    return t.trim();
                });
                ...
                this.parallax = new _parallax2.default(this.elem);

                this.elem.addEventListener('click', function (e) {
                    return _this5.clickHandler(e);
                });
                ...
                var tagsDisplay = this.elem.querySelector('.content .tags-display');
                if (tagsDisplay) {
                ...
                this.title = {
                    ...
                    display: function display() {
                        this._elem.className = 'in-initial';
                    },
                    fadeIn: function fadeIn() {
                        this._elem.className = 'fade-in';
                    },
                    fadeOut: function fadeOut() {
                        this._elem.className = 'fade-out';
                    },
                    fadeInLeft: function fadeInLeft() {
                        this._elem.className = 'in-from-left';
                    },
                    fadeInRight: function fadeInRight() {
                        this._elem.className = 'in-from-right';
                    },
                    fadeInTop: function fadeInTop() {
                        this._elem.className = 'in-from-top';
                    },
                    fadeOutLeft: function fadeOutLeft() {
                        this._elem.className = 'out-to-left';
                    },
                    fadeOutRight: function fadeOutRight() {
                        this._elem.className = 'out-to-right';
                    },
                    fadeOutTop: function fadeOutTop() {
                        this._elem.className = 'out-to-top';
                    },
                    moveDown: function moveDown() {
                        this._elem.className = 'down';
                    },
                    moveUp: function moveUp() {
                        this._elem.className = 'up';
                    }
                };
            }
            ...
            _createClass(CarouselCard, [{
                key: '_applyTransform',
                value: function _applyTransform() {
                    this.wrapper.style.transform = ['translateX(-50%)', 'translateX(' + this._translate + ')'].join(' ');
                }
                ...
                value: function setEnabled() {
                    ...
                    var totalTime = this.transitionTime * 1000;
                    var startTime = new Date();

                    var existingRot = this.parallax.rotmax;
                    var goal = enable ? 10 : 0;
                    var changeNeeded = goal - existingRot;
                    ...
                    function step(parallax) {
                        ...
                        if (timeElapsed < totalTime) {
                            var progress = timeElapsed / totalTime;
                            parallax.rotmax = existingRot + progress * changeNeeded;
                            parallax.rotate();
                            requestAnimationFrame(function () {
                                return step(parallax);
                            });
                ...
                value: function hide() {
                    ...
                    // If this is centered
                    var thisIndex = this.carousel.cards.indexOf(this);
                ...
                value: function expand() {
                    ...
                    var content = this.elem.getElementsByClassName('content')[0];

                    this.elem.classList.add('expanded-x');
                    this.title.moveDown();
                    this.disable();
                    this._expansionTimeout = setTimeout(function () {
                        _this6.elem.classList.add('expanded-y');
                        _this6._expansionTimeout = setTimeout(function () {
                            _this6.elem.style.maxHeight = 'none';
                            content.style.overflow = 'visible';
                            _this6.elem.classList.remove('expanded-y');
                            _this6.scrollHandler();
                        }, 500);
                ...
                key: 'fade',
                value: function fade() {
                    if (!this.hidden) this.elem.style.opacity = 0.5;
                }
  }, {
                key: 'opacify',
                value: function opacify() {
                ...
                value: function clickHandler(e) {
                    if (this.carousel && !this.hidden && !e.target.classList.contains('close-button')) {
                        var i1 = this.carousel.cards.indexOf(this);
                        var i2 = this.carousel.adjustIndex(i1);
                ...
                value: function scrollHandler() {
                    var scroll = this.wrapper.scrollTop;
                    // Float close button
                    var closeButton = this.carousel.closeButton;
                    var closeButtonPinThreshold = window.innerHeight - 44; // 44px is closeButton's offsetHeight
                    var cardBottom = this.elem.getBoundingClientRect().bottom;
                    ...
                    var transitionDistance = window.innerHeight / 10;
                    var progress = Math.min(scroll / transitionDistance, 1);
        ...
        var Carousel = exports.Carousel = function () {
            function Carousel(cards, dots, tags, emptyElem, closeButton) {
                var _this8 = this;
                ...
                window.addEventListener('click', function (e) {
                    // Outside of card
                    if (e.target.classList.contains('projects-container') || e.target.classList.contains('carousel-card-wrapper') || e.target === _this8.closeButton) {
                        if (typeof _this8.expandedIndex !== 'undefined') _this8.cards[_this8.expandedIndex].collapse();
                    }
                });
                ...
                window.addEventListener('keydown', function (e) {
                    ...
                    if (projectsContainer.parentNode.id === 'work-wrapper') {
                        if (e.key === 'ArrowRight') _this8.right();
                        if (e.key === 'ArrowLeft') _this8.left();
                    }
                });
            }
            ...
            _createClass(Carousel, [{
                ...
                value: function adjustIndex(index) {
                    return index - this.hiddenIndices.filter(function (i) {
                        return i < index;
                    }).length;
                }
  }, {
                key: 'expanded',
                value: function expanded(card) {
                    var _this9 = this;
                    ...
                    setTimeout(function () {
                        _this9.closeButton.classList.remove('hidden');
                    }, 500);
                }
  }, {
                key: 'collapsed',
                value: function collapsed() {
                    ...
                    setTimeout(function () {
                        _this10.position = _this10.position; // Re-layout
                        _this10.cards.forEach(function (c) {
                            return c.opacify();
                        });
                    }, 500);
                }
                ...
                key: '_filter',
                value: async function _filter(cardsToRemove) {
                    var _this11 = this;
                    ...
                    var selectedCard = this.cards.filter(function (c) {
                        return !c.hidden;
                    })[this.position];
                    // Hide cards
                    cardsToRemove.forEach(function (c) {
                        return c.hide();
                    }); // Play removed animation on affected cards
                    if (cardsToRemove.length) await delay(1000);
                    // Minimal movement (first non-hidden card after previously selected card)
                    var newCard = this.cards.slice(this.cards.indexOf(selectedCard)).find(function (c) {
                        return !c.hidden;
                    });
                    // Re-layout
                    this.hiddenIndices = cardsToRemove.map(function (c) {
                        return _this11.cards.indexOf(c);
                    });
                    ...
                    await delay(500);
                    var previouslyHidden = this.cards.filter(function (c) {
                        return c.hidden;
                    });
                    this.cards.filter(function (c) {
                        return !cardsToRemove.includes(c);
                    }).forEach(function (c) {
                        return c.show();
                    });
                    ...
                    await delay(1000);
                    var displayed = this.cards.filter(function (c) {
                        return !c.hidden;
                    });
                    var currentCard = displayed[this.position];
                ...
                value: function filter(tag) {
                    tag.opacify();
                    this.tags.filter(function (t) {
                        return t !== tag;
                    }).forEach(function (t) {
                        t.selected = false;
                        t.fade();
                    });
                    var cardsToRemove = this.cards.filter(function (c) {
                        return !c.tagNames.includes(tag.name);
                    });
                ...
                key: 'baseTransitionTime',
                get: function get() {
                    var answer = this.cards[0].baseTransitionTime;
                    // Warn if not every card has the same baseTransitionTime
                    if (!this.cards.every(function (card) {
                            return card.baseTransitionTime === answer;
                        })) console.warn('Carousel.baseTransitionTime called but baseTransitionTime of cards is inconsistent');
                    return answer;
                }
  }, {
                key: 'transitionTime',
                get: function get() {
                    var answer = this.cards[0].transitionTime;
                    // Warn if not every card has the same transitionTime
                    if (!this.cards.every(function (card) {
                            return card.transitionTime === answer;
                        })) console.warn('Carousel.transitionTime called but transitionTime of cards is inconsistent');
                    return answer;
                },
                set: function set(secs) {
                    this.cards.forEach(function (c) {
                        c.transitionTime = secs;
                    });
                }
  }, {
                key: 'position',
                ...
                set: function set(pos) {
                    ...
                    (async function () {
                        var delta = Math.abs(_this12._position - pos);

                        // Adjust transition time based on how many cards we're jumping
                        var btt = _this12.baseTransitionTime;
                        _this12.transitionTime = 0.5 * btt * ((delta || 1) - 1) + btt;

                        // If any card is open, collapse it and wait
                        if (delta > 0 && typeof _this12.expandedIndex !== 'undefined') {
                            _this12.cards[_this12.expandedIndex].collapse();
                            await delay(1000);
                        }

                        // Apply certain changes to each card
                        _this12.cards.forEach(function (card, index) {
                            var adj = function adj(i) {
                                return _this12.adjustIndex(i);
                            };
                            // Calculate position we're going to, and parse old position from old transform
                            var cardPosition = adj(index) - pos;
                            var oldTranslation = (card.translate || index * 48 + 'vw').slice(0, -2);
                            var oldPosition = [oldTranslation / 48, // Could be in its normal location
                                (oldTranslation - 12.5) / 48, // Could be to the right of an expanded card
                                (oldTranslation + 12.5) / 48].find(function (i) {
                                return Math.floor(i) === i;
                            }); // Whichever case yields an integer solution for position
                            // Calculate an offset based on position relative to any expanded card
                            var cardOffset = 0;
                            if (adj(index) > adj(_this12.expandedIndex)) cardOffset = 12.5;
                            if (adj(index) < adj(_this12.expandedIndex)) cardOffset = -12.5;
                            // Set new translation
                            var cardTranslation = 48 * cardPosition + cardOffset + 'vw';
                        ...
                        _this12._position = pos;
                        // Update carousel dots
                        if (_this12.dots) _this12.dots.update();
                    })();
                }
  }, {
                key: 'minIndex',
                ...
                key: 'maxIndex',
                get: function get() {
                    return Math.max(this.cards.length - this.hiddenIndices.length - 1, 0);
                }
  }]);
...
/***/
    (function (module, exports, __webpack_require__) {
        ...
        async function requestStars() {
            ...
            var users = ['controversial', 'arkis', 'pythonista-cloud'];
            ...
            var repos = (await Promise.all(requests)).reduce(function (a, b) {
                return a.concat(b);
            });
        ...
        exports.default = async function fetchStars() {
            var ghStars = void 0;
            var timeSinceRequest = new Date() - new Date(localStorage.ghStarsTimestamp);
...
/***/
    (function (module, exports, __webpack_require__) {
        ...
        module.exports = __webpack_require__.p + "main/index.html";
